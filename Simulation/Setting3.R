...
y_mean_1 <- y_mean_control + c(0,-0.1,-0.1,-4.8,-6)
y_mean_2 <- y_mean_control
y_mean_3 <- y_mean_control + c(0,0.1,0.1,4.8,6)
par(mfrow = c(1,3))
plot(time,y_mean_control,type = "b",lwd = 2,pch=20,lty = 6,cex = 2,ylab = "y_mean",main = "Subgroup 1",ylim = c(15,30))
...
plot(time,y_mean_control,type = "b",lwd = 2,pch=20,lty = 6,cex = 2,ylab = "y_mean",main = "Subgroup 2",ylim = c(15,30))
lines(time,y_mean_2,type = "b",lwd = 2,pch=2,lty = 1,cex = 2)
legend("bottomleft",legend = c("control","treatment"),lwd = c(2,2),pch = c(20,2),lty = c(6,1),cex = c(1.5,1.5))
plot(time,y_mean_control,type = "b",lwd = 2,pch=20,lty = 6,cex = 2,ylab = "y_mean",main = "Subgroup 3",ylim = c(15,30))
